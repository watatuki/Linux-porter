...
#define VI6_UDSn_HPHASE(index)		(0x2314 + (index * 0x100))
#define VI6_UDSn_VPHASE(index)		(0x2318 + (index * 0x100))
#define VI6_UDSn_HSZCLIP(index)		(0x231c + (index * 0x100))
#define VI6_UDSn_SZCLIP(index)		(0x2320 + (index * 0x100))
