				  ...
				  struct dma_slave_config *cfg)
{
	 ...
	 */
	chan->src_slave_addr = cfg->src_addr;
	chan->dst_slave_addr = cfg->dst_addr;
	chan->src_xfer_size = cfg->src_addr_width;
	chan->dst_xfer_size = cfg->dst_addr_width;
}
				...
				struct dma_slave_caps *caps)
{
	 ...
	 */
	caps->src_addr_widths = widths;
	caps->dstn_addr_widths = widths;
